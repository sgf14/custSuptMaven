...
public class ChatEndpoint implements HttpSessionListener {
	private static final String HTTP_SESSION_PROPERTY = "com.prod.custSuptMaven.ws.HTTP_SESSION";
    private static final String WS_SESSION_PROPERTY = "com.prod.custSuptMaven.http.WS_SESSION";
	...
	public void onOpen(Session session, @PathParam("sessionId") long sessionId) {
		...
		try {
			...
			if(sessionId < 1) {
				...
				message.setContent(username + " has joined the session.");
