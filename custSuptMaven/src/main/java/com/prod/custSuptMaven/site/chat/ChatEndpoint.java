...
/* class notes- chat package part of websockets introduced in chap 10
 * ChatEndpoint class receives chat connections and coordinates them- see pg 292
 * 
 * Spring Security chap 27 authorization re-factored this class fairly extensively as documented on pg 811
 * with a few methods added to class
 * no changes were required in earlier chap 26 authentication changes
 */
...
public class ChatEndpoint
{
    ...
    public void onOpen(Session session, @PathParam("sessionId") long sessionId)
    {
        ...
        // the doSecured wrap of the try statement introduced by chap 27 Spring security authorization function
        // a similar wrap done for all other websocket methods below also- onOpen, onClose etc
        this.doSecured(() -> {
	        try
	        {
	            ...
	            {
	                CreateResult result =
	                        this.chatService.createSession(this.principal.getUsername());
    ...
    //these methods added by chap 27 Spring security authorization functions, see pg 811 for description
    ...
    public static class EndpointConfigurator extends SpringConfigurator
    {
        ...
        //static var for below- chap 27 exchanged PRINCIPAL for SECURITY_CONTEXT
        ...
        //chap 27 Spring security authorization- this whole method got exchanged for SecurityContext instead
