...
<%--@elvariable id="comments" type="org.springframework.data.domain.Page<com.prod.custSuptMaven.site.TicketComment>"--%>

<%-- Note: spring:message utilizes i18n internationalzation file for all UI text displays, so any new
...
<!--     chap 22 ticket comments ui / pagination & ability to add new comments over time-->
